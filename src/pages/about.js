...
const AboutPage = () => {
	...
	<Layout pageTitle = "About the Black Death Digital Archive">
	    ...
	    pathogen’s effects on specific societies such as Bronze
	    Age Eurasia, the late medieval Mongol Empire, early modern
	    East Africa and India, and the modern American West.</p>

	    <p>The history of the micro-organism, however, only tells
	    one part of the overall story. The rest must be told by
	    bringing the biology into dialogue with what can be
	    learned from documentary and archaeological sources about
	    the actual causes of epidemic and pandemic events, and the
	    effects of such phenomena on human populations. Over the
	    last decade, our team members have implemented this new
	    approach to plague history in their scholarship. BDDA is a
	    natural outgrowth of our joint efforts to make this new
	    paradigm accessible to a larger community.</p>
	    </Layout>
    )
}
